...
const Chatbot = ({ user }) => {
  ...
  const fetchDirectLineToken = async () => {
    try {
      const response = await fetch("https://4e719def09e4e0ce82787973a70423.0a.environment.api.powerplatform.com/powervirtualagents/botsbyschema/cr61c_enterpriseCloudOpsDemo/directline/token?api-version=2022-03-01-preview");
      ...
      const styleOptions = {
        ...
        bubbleFromUserBackground: '#afaff6',
